...
class ReceivedQuestionnaire(models.Model):
    from_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="sent_questionnaires")
    to_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="received_questionnaires")
    questionnaire = models.ForeignKey(Questionnaire, on_delete=models.CASCADE)

    def __str__(self):
        return f"{self.from_user.get_username()}: {self.to_user.get_username()}: Q{self.questionnaire.id}"
